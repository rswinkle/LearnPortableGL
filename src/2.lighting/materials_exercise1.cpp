...
int main()
{
	...
	while (true)
	{
		...
		// light properties
		uniforms.light.ambient = vec3(1.0f, 1.0f, 1.0f); // note that all light colors are set at full intensity
		uniforms.light.diffuse = vec3(1.0f, 1.0f, 1.0f);
		uniforms.light.specular = vec3(1.0f, 1.0f, 1.0f);

		// material properties
		uniforms.material.ambient = vec3(0.0f, 0.1f, 0.06f);
		uniforms.material.diffuse = vec3(0.0f, 0.50980392f, 0.50980392f);
		uniforms.material.specular = vec3(0.50196078f, 0.50196078f, 0.50196078f);
