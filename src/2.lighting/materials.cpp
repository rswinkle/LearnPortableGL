...
int main()
{
	...
	while (true)
	{
		...
		uniforms.light.ambient = ambientColor;
		uniforms.light.diffuse = diffuseColor;
		uniforms.light.specular = vec3(1.0f, 1.0f, 1.0f);

		// material properties
		uniforms.material.ambient = vec3(1.0f, 0.5f, 0.31f);
		uniforms.material.diffuse = vec3(1.0f, 0.5f, 0.31f);
