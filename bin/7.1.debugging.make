...
RESCOMP = windres
TARGETDIR = .
TARGET = $(TARGETDIR)/7.1.debugging
INCLUDES += -I../inc
FORCE_INCLUDE +=
...
ifeq ($(config),debug)
OBJDIR = obj/Debug/7.1.debugging
DEFINES += -DDEBUG
...
OBJDIR = obj/Release/7.1.debugging
DEFINES += -DNDEBUG
...
$(OBJDIR)/debugging.o: ../src/7.in_practice/debugging.cpp
	@echo "$(notdir $<)"
